...
<body>
	...
	<!-- 실제 내용시작 -->  
  	<div class="container">
  		<!-- 점보트론(Jumbotron) -->
  		<div class="jumbotron">
  			<h1>Spring<small>HandlerMapping</small></h1>
  		</div>
  		<fieldset>
  			...
  			<ol>
  				...
  				<li><a href="<c:url value="/HandlerMapping/Annotaion.do"/>">DefaultAnnotaionUrlHandlerMapping</a></li>
  			</ol>
  			<h2>SimpleUrlHandlerMapping(기본 핸들러 맵핑이 아니다.)</h2>
  			<ol>
