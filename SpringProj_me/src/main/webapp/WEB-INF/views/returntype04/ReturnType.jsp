...
<body>
	...
	<!-- 실제 내용시작 -->  
  	<div class="container">
  		<!-- 점보트론(Jumbotron) -->
  		<div class="jumbotron">
  			<h1>Spring<small>컨트롤러 메서드의 반환타입</small></h1>
  		</div>
  		<fieldset>
  			<legend>컨트롤러 메서드의 반환타입</legend>
  			<ol>
  				...
  				<li><a href="<c:url value="/ReturnType/Void.do?returnType=void!!!"/>">void(Ajax나 Rest API에서 주로 사용) 반환</a></li>
  			</ol>
  			<h2>결과 값 출력</h2>
  			<ol>
